...
export const FirebaseContextProvider = ({ children }) => {
 ...
 const addOrderDB = async (cartProducts, userData, total) => {
  try {
    if (!userData || Object.keys(userData).length === 0 || !userData.name || !userData.surname || !userData.phone || !userData.email) {
    ...
    Swal.fire({
      ...
      text: `Tu número de orden es: ${orderId}.\n En breve nos pondremos en contacto para coordinar un horario`,
